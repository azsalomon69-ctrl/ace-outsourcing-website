(function(){
  ...
  const jobs=[
    ...
    {id:'graphic-designer',title:'Graphic Designer',department:'Creative',category:'tech',employmentType:'Full-time',location:'Santa Rosa, Laguna',priority:'active',summary:'Bring fresh ideas and visually compelling designs to life as part of the ACE creative team.',responsibilities:['Create digital and print marketing materials','Develop on-brand graphics for web and social media','Collaborate with marketing and internal teams'],qualifications:['Strong visual design portfolio','Proficiency with modern design tools','A keen eye for detail']},
    {id:'hr-officer',title:'HR Officer',department:'Human Resources',category:'operations',employmentType:'Full-time',location:'Santa Rosa, Laguna',priority:'active',summary:'Support smooth workforce operations, employee relations, policy implementation, and a positive workplace environment.',responsibilities:['Support recruitment, hiring, and onboarding','Handle employee relations and workplace concerns','Maintain employee records and HR documentation'],qualifications:['Strong communication and organization','Knowledge of Philippine labor practices','Confidentiality and professional ethics']},
    {id:'software-developer',title:'Software Developer',department:'Technology',category:'tech',employmentType:'Full-time',location:'Hybrid',priority:'active',summary:'Design, develop, and maintain high-quality software solutions while collaborating with cross-functional teams.',responsibilities:['Build and maintain reliable applications','Translate business requirements into technical solutions','Review, test, and improve code quality'],qualifications:['Software development experience','Strong problem-solving skills','Experience with version control and APIs']},
    {id:'marketing-manager',title:'Marketing Manager',department:'Marketing',category:'sales',employmentType:'Full-time',location:'Santa Rosa, Laguna',priority:'active',summary:'Develop and oversee marketing strategies that build awareness, generate leads, and support business growth.',responsibilities:['Develop marketing strategies and campaign plans','Manage brand consistency and content','Track campaign performance and improve results'],qualifications:['Marketing strategy experience','Digital marketing knowledge','Strong analytical and creative thinking']},
    {id:'data-entry',title:'Data Entry',department:'Operations',category:'operations',employmentType:'Full-time',location:'Santa Rosa, Laguna',priority:'open',summary:'Enter, update, verify, and organize business data accurately across digital systems and databases.',responsibilities:['Enter and update data','Check records for errors','Maintain organized digital files'],qualifications:['Fast and accurate typing','Strong attention to detail','Basic computer and spreadsheet knowledge']},
    {id:'full-time-marketing-manager',title:'Full-Time Marketing Manager',department:'Marketing',category:'sales',employmentType:'Full-time',location:'Paseo de Sta. Rosa',priority:'open',summary:'Lead multi-channel marketing strategy, content, campaigns, performance analysis, and budget planning for ACE.',responsibilities:['Develop marketing plans','Manage digital and paid campaigns','Track KPIs, budgets, and return on investment'],qualifications:["Bachelor's degree in a related field",'Three to five years of marketing experience','Strong written, analytical, and creative skills']},
    {id:'full-stack-developer',title:'Full-Stack Developer',department:'Technology',category:'tech',employmentType:'Full-time',location:'Hybrid',priority:'open',summary:'Build and maintain a SaaS platform across web, iOS, and Android using Laravel, Vue.js, Flutter, and Node.js.',responsibilities:['Develop SaaS applications','Build cross-platform interfaces','Maintain CI/CD and cloud deployments'],qualifications:['Laravel and Vue.js experience','Flutter experience','Node.js and REST API experience']},
    {id:'sales-development-manager',title:'Sales Development Manager',department:'Sales',category:'sales',employmentType:'Full-time',location:'Paseo Outlet, Sta. Rosa',priority:'open',summary:'Drive lead generation, manage sales operations, and develop strategies to acquire new BPO clients.',responsibilities:['Develop lead generation strategies','Manage the sales funnel and CRM','Monitor performance'],qualifications:['Three or more years of B2B sales experience','Experience with outsourcing sales','Strong leadership and communication']}
  ];
  const defaults={
    team:[
    ...
    testimonials:[
      {id:'jenny-m',name:'Jenny M.',company:'Be There Solutions',quote:'We have been working with Ace since their opening. We could not be happier with our team of representatives, they are a loyal, hardworking and dedicated team. Not only have they helped us lower our costs but we have also seen improved growth in our sales. Highly recommend!',logo:'assets/be-there-solutions.webp',rating:5},
      {id:'adam-j',name:'Adam J.',company:'Figshelf',quote:'As a tech startup, we were looking for the most cost-efficient ways to get our platform up and running. After being put in contact with Ace we were able to put a plan in place to help us build and scale as the platform requires more and more manpower. We are excited to go through this journey and expect a great outcome!',logo:'assets/figshelf.webp',rating:5},
      {id:'shai-a',name:'Shai A.',company:'Green Marketing',quote:'I was looking for a BPO to build a sales team, and I am very grateful I found Ace. From day one they were very professional and created a plan to recruit, onboard, train, and grow my team. So far the results have been excellent and I look forward to continuing the campaign and growing in the future.',logo:'assets/green-marketing.webp',rating:5}
    ],
    blogs:[
