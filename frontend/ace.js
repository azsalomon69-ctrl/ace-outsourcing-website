document.addEventListener('DOMContentLoaded',async()=>{
 ...
 document.querySelector('[data-map-load]')?.addEventListener('click',()=>{
  ...
  iframe.className='street-view-frame';iframe.src=mapContainer.dataset.mapSrc;iframe.title='Street View of ACE Outsourcing Solutions at Paseo de Sta. Rosa';iframe.loading='lazy';iframe.allowFullscreen=true;iframe.referrerPolicy='no-referrer';
